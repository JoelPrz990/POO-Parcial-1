...
Scanner sc = new Scanner(System.in);
    public Trapecio(int coordenada1X, int coordenada1Y, int coordenada2X, int coordenada2Y, int coordenada3X, int coordenada3Y, int coordenada4X, int coordenada4Y) {
    ...
    System.out.println("Cual es X de la coordenada 1: ");
        ...
        int baseMenor = this.coordenada4X - this.coordenada3X;
        int baseMayor = this.coordenada2X-this.coordenada1X;
